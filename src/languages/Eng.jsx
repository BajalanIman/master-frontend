...
export default {
  ...
  InfoHomePage:
    "Explore real-time meteorological data collected from various stations across Brandenburg, Germany, which are associated with or in cooperation with the Eberswalde University of Sustainable Development.",
  ...
  aboutApplicationP1:
    "Welcome to our platform dedicated to providing comprehensive meteorological and environmental data for various forest areas related to or in cooperation with Eberswalde University of Sustainable Development in Brandenburg, Germany.",
  ourMission: "Our Mission",
  ourMissionP1:
    "Our mission is to provide a centralized platform where individuals, researchers, and policy makers can access real-time and historical data on soil and air quality, climate variables, and pollutants at our stations. By aggregating data from meteorological stations located in different cities, we aim to provide a holistic understanding of the environmental dynamics within the region.",
  keyFeatures: "Key Features:",
  interactiveMaps: "Interactive Maps",
  interactiveMapsP1:
    "Explore our geographical locations of cities and meteorological stations across Brandenburg. Our interactive maps offer a visual representation of the distribution of environmental monitoring stations, aiding users in understanding the spatial context of our data.",
  ...
  interactiveMapsHelpP1:
    "Our interactive maps allow you to visualize our geographical distribution of cities, meteorological stations, and environmental variables across Brandenburg. Click on markers to view detailed information about specific locations.",
